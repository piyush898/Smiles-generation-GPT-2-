...
def save_smiles_with_non_100_similarity(molecule_file, pdb_file):
    ...
    # Save SMILES with less than 100% similarity to a new file
    with open('non_100_similarity_smiles.txt', 'w') as output_file:
...
if __name__ == "__main__":
    ...
    pdb_file_path = '/home/piyush22194/RNN/smiles-gpt-master/smiles-gpt-master/notebooks/pdb.txt'
